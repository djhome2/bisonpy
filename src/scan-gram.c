...
FILE *gram_in = NULL, *gram_out = NULL;
...
static yyconst flex_uint16_t yy_base[629] =
    {   0,
...
static yyconst flex_uint16_t yy_nxt[1410] =
    {   0,
...
static yyconst flex_int16_t yy_rule_linenum[132] =
    {   0,
      213,  216,  217,  218,  224,  242,  243,  244,  245,  246,
      247,  248,  249,  250,  251,  252,  253,  254,  255,  256,
      257,  258,  259,  260,  261,  262,  263,  264,  265,  266,
      267,  268,  269,  270,  271,  272,  273,  274,  275,  276,
      277,  278,  279,  280,  281,  282,  283,  287,  291,  295,
      298,  299,  300,  301,  302,  303,  304,  305,  306,  308,
      313,  314,  315,  316,  318,  325,  326,  330,  336,  339,
      340,  343,  346,  354,  361,  362,  363,  369,  376,  383,
      404,  419,  434,  440,  459,  473,  492,  508,  525,  526,
      537,  548,  549,  561,  571,  576,  586,  598,  622,  634,

      648,  649,  660,  664,  668,  669,  670,  671,  672,  673,
      674,  677,  679,  683,  695,  711,  716,  717,  723,  724,
      735,  741,  747,  753,  769,  770,  774,  781,  797,  817,
      856
    } ;
...
/* Report that gram_text is an extension, and evaluate to its token kind.  */
#define BISON_DIRECTIVE(Directive)                              \
  (bison_directive (loc, gram_text), PERCENT_ ## Directive)
...
void gram_set_in  (FILE * _in_str  );

FILE *gram_get_out (void );

void gram_set_out  (FILE * _out_str  );
...
void gram_set_lineno (int _line_number  );
 ...
 * we now use fwrite().
 */
#define ECHO do { if (fwrite( gram_text, (size_t) gram_leng, 1, gram_out )) {} } while (0)
/* %endif */
...
/* %% [5.0] fread()/read() definition of YY_INPUT goes here unless we're doing C++ \ */\
	if ( YY_CURRENT_BUFFER_LVALUE->yy_is_interactive ) \
		...
		{ \
		errno=0; \
		while ( (result = (int) fread(buf, 1, (yy_size_t) max_size, gram_in)) == 0 && ferror(gram_in)) \
			{ \
			if( errno != EINTR) \
				{ \
				YY_FATAL_ERROR( "input in flex scanner failed" ); \
...
RETURN_VALUE (PERCENT_FILE_PREFIX, uniqstr_new (gram_text));
	YY_BREAK
case 18:
YY_RULE_SETUP
...
RETURN_VALUE (PERCENT_PURE_PARSER, uniqstr_new (gram_text));
	YY_BREAK
...
RETURN_VALUE (PERCENT_ERROR_VERBOSE, uniqstr_new (gram_text));
	YY_BREAK
...
RETURN_VALUE (PERCENT_NAME_PREFIX, uniqstr_new (gram_text));
	YY_BREAK
...
case 57:
YY_RULE_SETUP
#line 304 "src/scan-gram.l"
DEPRECATED_DIRECTIVE ("%no-lines");
	YY_BREAK
case 58:
/* rule 58 can match eol */
YY_RULE_SETUP
#line 305 "src/scan-gram.l"
...
case 64:
YY_RULE_SETUP
#line 316 "src/scan-gram.l"
return SEMICOLON;
	YY_BREAK
case 65:
YY_RULE_SETUP
#line 318 "src/scan-gram.l"
{
    val->ID = uniqstr_new (gram_text);
    id_loc = *loc;
...
RETURN_VALUE (INT_LITERAL, scan_integer (gram_text, 10, *loc));
	YY_BREAK
case 67:
YY_RULE_SETUP
#line 326 "src/scan-gram.l"
RETURN_VALUE (INT_LITERAL, scan_integer (gram_text, 16, *loc));
	YY_BREAK
...
{
    STRING_GROW_ESCAPE (strtol (gram_text + 1, NULL, 8));
  }
	YY_BREAK
case 104:
YY_RULE_SETUP
...
{
    STRING_GROW_ESCAPE (strtol (gram_text + 2, NULL, 16));
  }
	YY_BREAK
case 105:
YY_RULE_SETUP
...
STRING_GROW_ESCAPE (gram_text[1]);
	YY_BREAK
case 113:
YY_RULE_SETUP
#line 679 "src/scan-gram.l"
{
    STRING_GROW_ESCAPE (convert_ucn_to_byte (gram_text));
  }
	YY_BREAK
case 114:
...
/* %endif */
{
		...
		while ( num_to_read <= 0 )
			...
			if ( b->yy_is_our_buffer )
				...
				b->yy_ch_buf = (char *)
					...
					gram_realloc((void *) b->yy_ch_buf,(yy_size_t) (b->yy_buf_size + 2)  );
				}
			else
	...
	if ((int) ((yy_n_chars) + number_to_move) > YY_CURRENT_BUFFER_LVALUE->yy_buf_size) {
		...
		YY_CURRENT_BUFFER_LVALUE->yy_ch_buf = (char *) gram_realloc((void *) YY_CURRENT_BUFFER_LVALUE->yy_ch_buf,(yy_size_t) new_size  );
...
/* %endif */
{
	 ...
	 */
	b->yy_ch_buf = (char *) gram_alloc((yy_size_t) (b->yy_buf_size + 2)  );
	if ( ! b->yy_ch_buf )
		YY_FATAL_ERROR( "out of dynamic memory in gram__create_buffer()" );
...
YY_BUFFER_STATE gram__scan_string (yyconst char * yystr )
{
	...
	return gram__scan_bytes(yystr,(int) strlen(yystr) );
}
/* %endif */
...
void gram_set_debug (int  _bdebug )
{
        gram__flex_debug = _bdebug ;
}
